  ...
  return (
    <section className="trade-board">
      <div className="grid two">
        <OfferZone title="Your Offer" items={myOfferItems} droppableId="my-offer" onDoubleClickOfferItem={onDoubleClickOfferItem} />
      ...
      <div className="card trade-actions">
        ...
        <div className="inline-controls">
          <button disabled={!canAccept || myAccepted} onClick={onAccept}>{myAccepted ? 'Accepted' : 'Accept Trade'}</button>
          <button disabled={!canConfirm || myConfirmed} onClick={onConfirm}>{myConfirmed ? 'Confirmed' : 'Confirm Trade'}</button>
        </div>
      </div>
    </section>
  );
